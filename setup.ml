(* OASIS_START *)
(* DO NOT EDIT (digest: 24668ba03ef332fd9a2f8fcc58335305) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Delimited overloading is a syntax extension to ease the writing of efficient arithmetic expressions in OCaml.  It allows out of the box to use the usual arithmetic operators for Int32, Int64, Nativeint, Num, and Complex.  A fake \"Float\" module is also provided. Some optimizations are performed, in particular for the module Complex.";
                 OASISText.Para
                   "This syntax extension can be further extended: you can write overloadings for your own modules using either the concrete syntax or by writing a small syntax module."
              ];
          tags = [];
          categories = [];
     ...
     oasis_digest = Some "\242\024:\204\002\176b\235\231V\183\210%}\214\248";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
